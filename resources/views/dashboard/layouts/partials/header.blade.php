<header id="header-container" class="fixed fullwidth dashboard">
	...
	<div id="header" class="not-sticky">
		<div class="container" class="not-sticky">
			...
			<div class="left-side">
				...
				<div id="logo">
					...
					<a href="{{route("home")}}" class="dashboard-logo"><img src="/images/logo2.png" alt=""></a>
				</div>
				...
				<nav id="navigation" class="style-1">
					<ul id="responsive">
                        ...
                        <li>
                            <a  href="{{route("dashboard.listing.workplace")}}">İş Yerleri</a>
                        </li>
                        <li>
                            <a  href="{{route("dashboard.profile.show")}}">Profilim</a>
                        </li>
                        <li>
                            <a  href="{{route("dashboard.messages")}}">Mesajlarım</a>
                        </li>
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<!-- User Menu -->
					<div class="user-menu">
						<div class="user-name"><span><img src="{{auth()->user()->userDetails->image ?? "/images/dashboard-avatar.jpg" }}" alt=""></span>My Account</div>

					</div>

					<a href="{{route("dashboard.add_listing")}}" class="button border with-icon">Add Listing <i class="sl sl-icon-plus"></i></a>
				</div>
				<!-- Header Widget / End -->
			</div>
			<!-- Right Side Content / End -->
