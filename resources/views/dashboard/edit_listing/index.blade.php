...
<div class="dashboard-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{route("dashboard.workplace.edit")}}" method="POST"  enctype="multipart/form-data">
                <input type="hidden" value="{{encrypt($workplace->id)}}" name="workplace_id">
                @csrf
                <div id="add-listing">

                    <!-- Section -->
                    @include('dashboard.edit_listing.basic_information')
                    <!-- Section / End -->

                    <!-- Section -->
                    @include('dashboard.edit_listing.location')

                    <!-- Section / End -->
                    @include('dashboard.edit_listing.gallery')
                    ...
                    <!-- Section -->
                    @include('dashboard.edit_listing.details')
                    ...
                    <!-- Section -->
                    @include('dashboard.edit_listing.pricing')
