...
if(document.getElementById("map") !== null){
	...
	// ----------------------------------------------- //
    var deneme = [];
    map_locations.forEach(element => {
        deneme.push([ locationData(element["url"],element["image"],element["name"],element["address"], '3.5', '12'), element["location_1"], element["location_2"], 1, '<i class="fas fa-home"></i>'])
    });
    var locations = deneme;
	// var locations = [
